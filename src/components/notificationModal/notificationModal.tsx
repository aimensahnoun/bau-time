  ...
  return (
    <AnimatePresence exitBeforeEnter>
      {isModalOpen && (
        ...
        >
          <div className="py-2 flex flex-col flex-wrap max-w-[10rem] static">
            {myNotifications.map((notification) => {
              ...
              return (
                <div
                  key={notification.id}
                  className={
                    `flex flex-col flex-wrap  gap-y-2 p-2 w-[20rem] border-b border-gray-700 ${!notification.isRead && "bg-bt-dark-gray" } `
                  }
                >
